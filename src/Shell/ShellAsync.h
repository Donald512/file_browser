...
namespace WShell::Async{
    ...
    void RequestIcon(AppContext& ctx, const WShell::Item& item);
    void RequestTooltip(AppContext& ctx, const WShell::Item& item);
    void RequestMeta(AppContext& ctx, const WShell::Item& item);    // Typename + Size - virtual items only
    void RequestTileInfo(AppContext& ctx, const WShell::Item& item);
