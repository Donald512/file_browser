...
// params copies by value, cos it copies the pointers, so even if whatever called it has its stack collapsed, it copied the pointer to the data needed, and frees here
