...
static const char* GetLabelForViewMode(ViewMode viewMode){
    switch(viewMode){
...
static const char* GetIconForViewMode(ViewMode viewMode){
    switch(viewMode){
...
static const char* GetLabelForSortMode(SortMode sortMode){
    switch(sortMode){
...
static const char* GetLabelForSortDir(SortDirection sortDir){
    switch(sortDir){
...
static const char* GetIconForSortDir(SortDirection sortDir){
    switch(sortDir){
