...
ItemInteraction DrawItemChrome(DragInfo& dragInfo, ImDrawList* dl, ImGuiWindow* window, CommandQueue& cmdQueue, Tab& activeTab, size_t activeTabIndex, f32 dpi, DirListing& listing, int visualIndex, const ImRect& fullRect, f32 rounding, bool drawFocusRing = true, bool drawBg = true);
